    ...
    return (
        <Container section className={s.wrapper} id="about-us">
            ...
            <div  className={s.content}>
                ...
                <p className={[s.description, mont.className].join(" ")}>Since 1994, Jack's Jewelry and Loan has been providing
                ...
                <p className={[s.description, mont.className].join(" ")}>
                    ...
                    secure a loan, Jack's Jewelry and Loan is here to help you
